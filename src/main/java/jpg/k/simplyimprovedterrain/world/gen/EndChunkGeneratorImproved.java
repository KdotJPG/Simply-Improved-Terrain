...
public class EndChunkGeneratorImproved extends NoiseChunkGeneratorImproved<EndGenerationSettings> {
    ...
    public EndChunkGeneratorImproved(IWorld world, BiomeProvider provider, EndGenerationSettings settings) {
        super(world, provider, 8,128, settings, 3, 2, 1368.824D, 684.412 * 2, 17.110300000000002D, 4.277575000000001D * 2);

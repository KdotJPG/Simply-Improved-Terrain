...
public class OverworldChunkGeneratorImproved extends NoiseChunkGeneratorImproved<OverworldGenSettings> {
    ...
    public OverworldChunkGeneratorImproved(IWorld world, BiomeProvider provider, OverworldGenSettings settings) {
    ...
    protected double[] getColumnBiomeParams(int xc, int zc) {
        ...
        adouble[0] = (double)f1;// + this.modulateBiomeParameter(xc, zc);
        adouble[1] = (double)f;
        return adouble;
    }

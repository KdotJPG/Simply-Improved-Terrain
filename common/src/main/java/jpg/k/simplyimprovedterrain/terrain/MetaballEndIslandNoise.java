...
public class MetaballEndIslandNoise
{
    ...
    private static final int OUTER_ISLANDS_DISTANCE = 1024;
    private static final double ISLANDS_FREQUENCY = 0.004;
    private static final int OUTER_ISLANDS_MIN_RADIUS = 38;
    private static final int OUTER_ISLANDS_MAX_RADIUS = 89;
    ...
    public static final MetaballEndIslandNoise INSTANCE = new MetaballEndIslandNoise(
            MAIN_ISLAND_RADIUS, OUTER_ISLANDS_MIN_RADIUS, OUTER_ISLANDS_MAX_RADIUS, OUTER_ISLANDS_DISTANCE, ISLANDS_FREQUENCY);
